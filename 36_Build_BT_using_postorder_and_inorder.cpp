...
BinaryTreeNode<int>* buildTree(int *postorder, int postLength, int *inorder, int inLength) 
{
    ...
    int rightlen=inLength-leftlen-1;
    BinaryTreeNode<int>* l= buildTree(postorder,leftlen,inorder,leftlen);
    BinaryTreeNode<int>* r= buildTree(postorder+leftlen,rightlen,inorder+leftlen+1,rightlen);
    root->left=l;
    root->right=r;
    return root;
}
