...
// in binary tree besides pre order and post order there is another order which is in order
// in this first left node is printed then the parent node and then the right node
